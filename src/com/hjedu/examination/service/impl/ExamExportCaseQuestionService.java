...
public class ExamExportCaseQuestionService implements Serializable {
    ...
    public void export(String nfn) {
        try {
            ...
            this.initChoice(book);
            this.initMultiChoice(book);
            this.initFill(book);
            this.initJudge(book);
            this.initEssay(book);
            this.initFile(book);
    ...
    private void exportCase(WritableWorkbook book) {
        try {
            // 生成名为“问答题”的作业表
            WritableSheet sheet1 = book.getSheet(6);
            ...
            for (ExamModuleModel em : modules) {
                ...
                for (CaseQuestion cq : cqs) {
                    ...
                    this.exportChoice(book, cq, i1);
                    this.exportMultiChoice(book, cq, i1);
                    this.exportFill(book, cq, i1);
                    this.exportJudge(book, cq, i1);
                    this.exportEssay(book, cq, i1);
                    //this.exportFile(book, cq, i1);
                }
                //导出本模块中所有综合题完成
            }
    ...
    private void exportChoice(WritableWorkbook book, CaseQuestion ccq, int caseOrder) {
       
        try {
            int total = 0;
            WritableSheet sheet1 = book.getSheet(0);
            if (sheet1 != null) {
                total = sheet1.getRows();
            }
            int i1 = total;
            List<ChoiceQuestion> cqs = ccq.getChoices();
            if (cqs != null) {
                for (ChoiceQuestion cq : cqs) {
                    ...
                    //设置综合题
                    Label labelCC = new Label(11, i1, String.valueOf(caseOrder));
    ...
    private void exportMultiChoice(WritableWorkbook book, CaseQuestion ccq, int caseOrder) {
        try {
            int total = 0;
            ...
            int i1 = total;
            List<MultiChoiceQuestion> cqs = ccq.getMultiChoices();
            if (cqs != null) {
    ...
    private void exportFill(WritableWorkbook book, CaseQuestion ccq, int caseOrder) {
        try {
            int total = 0;
            WritableSheet sheet1 = book.getSheet(2);
            ...
            List<FillQuestion> cqs = ccq.getFills();
            if (cqs != null) {
                for (FillQuestion cq : cqs) {
                    ...
                    //设置综合题
                    Label labelCC = new Label(4, i1, String.valueOf(caseOrder));
                    sheet1.addCell(labelCC);
    ...
    private void exportJudge(WritableWorkbook book, CaseQuestion ccq, int caseOrder) {
        try {
            int total = 0;
            WritableSheet sheet1 = book.getSheet(3);
            ...
            //导出本模块中所有判断题
            List<JudgeQuestion> cqs = ccq.getJudges();
            if (cqs != null) {
                for (JudgeQuestion cq : cqs) {
                    ...
                    //设置综合题
                    Label labelCC = new Label(5, i1, String.valueOf(caseOrder));
                    sheet1.addCell(labelCC);
    ...
    private void exportEssay(WritableWorkbook book, CaseQuestion ccq, int caseOrder) {
        try {
            int total = 0;
            WritableSheet sheet1 = book.getSheet(4);
            ...
            int i1 = total;
            //导出本模块中所有问答题
            List<EssayQuestion> cqs = ccq.getEssaies();
            if (cqs != null) {
    ...
    private void initChoice(WritableWorkbook book) {
        try {
            ...
            sheet1.addCell(label0);
            Label label1 = new Label(1, 0, "模块名称",wcfF);
            sheet1.addCell(label1);
            sheet1.setColumnView(1, 20);
            Label label2 = new Label(2, 0, "题目",wcfF);
            sheet1.addCell(label2);
            sheet1.setColumnView(2, 50);
            Label label3 = new Label(3, 0, "正确答案",wcfF);
            sheet1.addCell(label3);
            Label label4 = new Label(4, 0, "选项A",wcfF);
            sheet1.addCell(label4);
            sheet1.setColumnView(4, 20);
            Label label5 = new Label(5, 0, "选项B",wcfF);
            sheet1.addCell(label5);
            sheet1.setColumnView(5, 20);
            Label label6 = new Label(6, 0, "选项C",wcfF);
            sheet1.addCell(label6);
            sheet1.setColumnView(6, 20);
            Label label7 = new Label(7, 0, "选项D",wcfF);
            sheet1.addCell(label7);
            sheet1.setColumnView(7, 20);
            Label label8 = new Label(8, 0, "选项E",wcfF);
            sheet1.addCell(label8);
            sheet1.setColumnView(8, 20);
            Label label9 = new Label(9, 0, "选项F",wcfF);
            sheet1.addCell(label9);
            sheet1.setColumnView(9, 20);
            Label label10 = new Label(10, 0, "试题解析",wcfF);
            sheet1.addCell(label10);
            sheet1.setColumnView(10, 40);

            Label label11 = new Label(11, 0, "综合题序号",wcfF);
    ...
    private void initMultiChoice(WritableWorkbook book) {
        try {
            WritableSheet sheet1 = null;

            // 生成名为“多选题”的作业表，参数0表明这是多选题
            sheet1 = book.createSheet("多选题", 1);
            Label label0 = new Label(0, 0, "序号");
            sheet1.addCell(label0);
            Label label1 = new Label(1, 0, "模块名称");
            sheet1.addCell(label1);
    ...
    private void initFill(WritableWorkbook book) {
        try {
            WritableSheet sheet1 = null;
            // 生成名为“填空题”的作业表，参数0表明这是填空题
            sheet1 = book.createSheet("填空题", 2);
            Label label0 = new Label(0, 0, "序号");
            sheet1.addCell(label0);
            Label label1 = new Label(1, 0, "模块名称");
            sheet1.addCell(label1);
    ...
    private void initJudge(WritableWorkbook book) {
        try {
            WritableSheet sheet1 = null;
            // 生成名为“判断题”的作业表，参数0表明这是判断题
            sheet1 = book.createSheet("判断题", 3);
            Label label0 = new Label(0, 0, "序号");
            sheet1.addCell(label0);
            Label label1 = new Label(1, 0, "模块名称");
            sheet1.addCell(label1);
    ...
    private void initEssay(WritableWorkbook book) {
        try {
            WritableSheet sheet1 = null;
            // 生成名为“问答题”的作业表
            sheet1 = book.createSheet("问答题", 4);
            Label label0 = new Label(0, 0, "序号");
            sheet1.addCell(label0);
            Label label1 = new Label(1, 0, "模块名称");
            sheet1.addCell(label1);
    ...
    private void initFile(WritableWorkbook book) {
        try {
            // 生成名为“文件题”的作业表
            WritableSheet sheet1 = book.createSheet("文件题", 5);
            Label label0 = new Label(0, 0, "序号");
    ...
    private void initCase(WritableWorkbook book) {
        try {
            // 生成名为“问答题”的作业表
    ...
    public static void main(String args[]) {
        ExamExportCaseQuestionService ees = new ExamExportCaseQuestionService();
