...
@ManagedBean
@ViewScoped
public class ListFillQuestion  implements Serializable{
...
//    }
    ...
    public LazyFillQuestionList getLcqs() {
        return lcqs;
    }

    public void setLcqs(LazyFillQuestionList lcqs) {
        this.lcqs = lcqs;
    }
    ...
    public void buildLazy() {
        if (lcqs == null) {
            this.lcqs = new LazyFillQuestionList(this.module.getId());
        }
