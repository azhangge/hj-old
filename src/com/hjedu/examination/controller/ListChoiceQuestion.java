...
@ManagedBean
@ViewScoped
public class ListChoiceQuestion implements Serializable {
...
//    }
    ...
    public LazyChoiceQuestionList getLcqs() {
        return lcqs;
    }

    public void setLcqs(LazyChoiceQuestionList lcqs) {
        this.lcqs = lcqs;
    }
    ...
    public void buildLazy() {
        if (lcqs == null) {
            this.lcqs = new LazyChoiceQuestionList(this.module.getId());
        }
    }
    ...
    public void batchDelete() {
        List<ChoiceQuestion> cqs = this.lcqs.getModels();
