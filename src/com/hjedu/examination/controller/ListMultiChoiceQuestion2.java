...
@ManagedBean
@ViewScoped
public class ListMultiChoiceQuestion2 implements Serializable {
    ...
    public void setQuestions(List<MultiChoiceQuestion> questions) {
    ...
    public void batchDelete() {
        List<MultiChoiceQuestion> cqs=this.questions;
