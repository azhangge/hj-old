...
import com.hjedu.examination.service.impl.IntensiveExamService;
...
@ManagedBean
@ViewScoped
public class ListIntensiveExam{

    ILogService logger = SpringHelper.getSpringBean("LogService");
    IntensiveExamService examDAO = SpringHelper.getSpringBean("IntensiveExamService");
