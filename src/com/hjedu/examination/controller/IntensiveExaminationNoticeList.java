...
@ManagedBean
@ViewScoped
public class IntensiveExaminationNoticeList implements Serializable {
    ...
    public void init() {
        ...
        if (lid != null) {
        	...
        	List<Examination> exams = examDAO.findAllntensiveExamination();
        	this.exams =exams;
        }
     ...
     * @return 
     */
    public boolean isReg(String examId){
    	IntensiveExamAndUser iea=intensiveExamAndUserDAO.getIntensiveExamAndUserByUserExamId(this.userId, examId);
        if(iea!=null){
        	return true;
        }
    	return false;
