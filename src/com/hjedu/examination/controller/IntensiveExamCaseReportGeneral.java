...
@ManagedBean
@ViewScoped
public class IntensiveExamCaseReportGeneral implements Serializable {
    ...
    public void init() {
        ...
        if (case_id != null) {
            examCase = this.examCaseService.retrieveExamCase(case_id);
            if (examCase != null) {
    ...
    public String submitReport() {
        ...
        this.examCaseService.recomputeExamCase(examCase);
        return result;
    }
