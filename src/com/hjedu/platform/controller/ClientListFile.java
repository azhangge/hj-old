...
@ManagedBean
@ViewScoped
public class ClientListFile implements Serializable {
    ...
    public void synDB() {
        ...
        if (bu != null) {
            this.pro2s = this.project2DAO.findAllClientFileByUsr(bu.getId(), this.fatherID);
        }
    }
    ...
    public String reBuild() {
        ...
        if (fid != null) {
            String id = fid;
            this.fatherID = id;
            MyLogger.echo("FatherID:" + fid);
        } else {
            this.fatherID = "0";
        }
        this.synDB();
        this.genGrapaID();
        this.familyTree = this.complex.genFamilyTree(this.fatherID);
        return null;
    }
