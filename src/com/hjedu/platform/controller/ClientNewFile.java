...
@ManagedBean
@ViewScoped
public class ClientNewFile extends NewFileAbstract {
	...
	public void checkName() {
		...
		boolean b = project2DAO.checkNameIfExistByUsr(fileName.trim(), this.fatherID, uid);
		if (b) {
