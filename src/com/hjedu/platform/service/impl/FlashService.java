...
public class FlashService  implements Serializable{

    
    private String relativeDir = SpringHelper.getSpringBean("relativeDir");

    public void deleteRelativeFlash(ServletContext sc, String id) {
    ...
    public void transferAllUserFlashs(ServletContext sc) {
        StringBuilder dir = new StringBuilder();
        dir.append(this.loadOriginalFilePath(sc));
        //dir.append("c:\\tt\\");
        dir.append("user_flashes/");
        ...
        if (fs != null) {
            for (String s : fs) {
                MyLogger.echo(s);
                this.transferUserFlashsToRelativeDir(sc, s);
            }
        }
    }
    ...
    public void transferUserFlashsToRelativeDir(ServletContext sc, String id) {
        try {
