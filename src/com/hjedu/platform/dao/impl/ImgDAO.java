...
public class ImgDAO implements IImgDAO , Serializable {
    ...
    /**
     * 文件保存路径类似这种形式C:/huajie_exam/user_images中
     */
    @Override
    public void saveImg(InputStream fis, String  id) {
        try {
