...
import com.hjedu.customer.service.impl.AdminImportService;
...
@ManagedBean
@ViewScoped
public class AdminImportExport implements Serializable {
    
	ILogService logger = SpringHelper.getSpringBean("LogService");
    AdminImportService eis = SpringHelper.getSpringBean("AdminImportService");
    ...
    public String clearAllUsers() {
        ...
        List<BbsUser> users = bbsUserDAO.findAllBbsUser(CookieUtils.getBusinessId(JsfHelper.getRequest()));
