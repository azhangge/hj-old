...
@WebServlet(urlPatterns = {"/servlet/pc/RegIntensiveExamController"})
public class RegIntensiveExamController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getContextPath() + "/talk/RegIntensiveExam.jspx?id="+id;
