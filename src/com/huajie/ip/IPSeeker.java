...
public class IPSeeker
{
  ...
  private int IP_RECORD_LENGTH = 7;
  private byte AREA_FOLLOWED = 1;
  private byte NO_AREA = 2;
  ...
  public IPSeeker(String filePath) {
    this.IP_FILE = filePath;
    build();
  }
  ...
  private void build() {
    if (this.IP_FILE == null)
    {
      URL p1 = IPSeeker.class
        .getResource("/qqwry.dat");

      System.out.println(p1);
      this.IP_FILE = p1.toString().substring(5);
    }
    ...
    try {
      ...
      System.out.println(IPSeeker.class.getResource("/QQWry.dat")
        .toString());
      System.out.println(this.IP_FILE);
  ...
  public List<IPEntry> getIPEntries(String s) {
    ...
    try {
      if (this.mbb == null) {
        ...
        this.mbb = fc.map(FileChannel.MapMode.READ_ONLY, 0L, this.ipFile
          .length());
