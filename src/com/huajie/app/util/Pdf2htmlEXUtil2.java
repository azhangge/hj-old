...
import com.hjedu.course.controller.AALesson;
import com.huajie.app.util.StreamGobbler;

/**
 * @author liuzhengyong
 * @version 1.0 时间：2013-12-30 下午2:24:10 pdf文件转html工具类
 */
public class Pdf2htmlEXUtil2 {
	private static final Logger log4j = Logger.getLogger(Pdf2htmlEXUtil2.class);
    /**
    ...
    public static boolean pdf2html(String exeFilePath, String pdfFile, String destDir, String htmlFileName) {
        ...
        File f = new File(destDir+htmlFileName);
        if(f.exists()){//已存在
        	return true;
        }
        ...
        command.append("--fit-width 740 ");//适合宽度px像素
...
//        command.append("--no-drm 1"); //覆盖文档的 DRM 设置 (default: 0)  
    ...
    public static void main(String[] args) {
        pdf2html("C:\\pdf2htmlEX-0.12-win32-static-with-poppler-data\\pdf2htmlEX.exe","D:\\test3\\test.pdf","D:\\test\\HTML","my.html");
    }
}