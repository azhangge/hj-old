/*
    ...
    ben@xoxco.com
    ----------------------------------------1.3.3 Kai 0.1-------------------------------------------
    jQuery Tags Input Plugin 1.3.3 Kai 0.1
    what's new
    add 1 function[getTags()]
    add 4 options default[maxCount:0,lowerCase:false,upperCase:false,regex:'']
    fix some error display addClass('not_valid')
    2012-11-08 jsd.xug@sjtu.edu.cn
    ------------------------------------------------------------------------------------------------
*/
