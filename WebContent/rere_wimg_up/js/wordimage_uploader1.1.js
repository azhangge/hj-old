...
function WordImageUploader(s_url, app_name,rep_str1,rep_str2)
{
...
// 构造函数代码 
    ...
    var printRequiredHtml11 = function() {
        ...
        var yy2 = '<applet id=\"wordImageApplet\" name=\"wordImageApplet\" code=\"com.huajie.applet.FileAdapter\" codebase=\"' + appName + '/rere_wimg_up/applet\" archive=\"examapplet.jar,apache-mime4j-0.6.jar,commons-logging-1.1.3.jar,httpclient-4.0.3.jar,httpcore-4.0.1.jar,httpmime-4.0.3.jar\" width=\"100%\" height=\"22\"></applet>';
        var yy3 = '</div>';
    ...
    var yy4 = '<span style="color:blue;font-size:12px;">&nbsp;&nbsp;未安装JAVA环境或JAVA运行不正常，“图片自动上传插件”不能运行，<a href="http://java.com/zh_CN/download/installed8.jsp" target="_blank">点此验证JDK</a>。</span>';
    var cjj = checkJRE();
    if (cjj != 1) {
    ...
    _this.uploadLocalFile = function(localUrl, name) {
        ...
        result = result.replace(repStr1, repStr2);
        return result;
    }
