...
<%
    ...
    if (uid != null) {
        IQuestionCollectionDAO wrongDAO = SpringHelper.getSpringBean("QuestionCollectionDAO");
        if (uid != null) {
            long cnum = wrongDAO.getQuestionCollectionNumByUsrAndQtype( uid,"choice");
            long mcnum = wrongDAO.getQuestionCollectionNumByUsrAndQtype(uid,"mchoice");
            long fnum = wrongDAO.getQuestionCollectionNumByUsrAndQtype(uid,"fill");
            long jnum = wrongDAO.getQuestionCollectionNumByUsrAndQtype(uid,"judge");
            long eenum = wrongDAO.getQuestionCollectionNumByUsrAndQtype(uid,"essay");
            long ffnum = wrongDAO.getQuestionCollectionNumByUsrAndQtype( uid,"file");
