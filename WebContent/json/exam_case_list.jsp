...
<%@page import="com.huajie.exam.model.ExamCase,com.huajie.exam.dao.IExamCaseDAO"%>

<%
    String uid = request.getParameter("uid");
    if (uid != null) {
        IExamCaseDAO examDAO = SpringHelper.getSpringBean("ExamCaseDAO");
        java.util.List<ExamCase> exams = examDAO.findExamCaseByUser(uid);
